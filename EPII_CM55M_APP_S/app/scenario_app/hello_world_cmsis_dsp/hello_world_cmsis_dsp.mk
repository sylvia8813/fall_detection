...
APPL_DEFINES += -DHELLO_WORLD_CMSIS_DSP
...
##
LIB_SEL = pwrmgmt sensordp spi_ptl spi_eeprom hxevent img_proc cmsis_dsp
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/hello_world_cmsis_dsp_S_only.sct
else #TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/hello_world_cmsis_dsp_S_only.ld
endif
##
