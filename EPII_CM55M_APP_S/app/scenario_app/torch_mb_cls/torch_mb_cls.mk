...
##
LIB_SEL = pwrmgmt sensordp torchtag1_0_0_u55tag2502 spi_ptl spi_eeprom hxevent img_proc
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TORCH_mb_cls_S_only.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TORCH_mb_cls_S_only.ld
endif
