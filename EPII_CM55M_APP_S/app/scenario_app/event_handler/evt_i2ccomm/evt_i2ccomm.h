...
/**
 * \brief   Callback function for i2c slave 0 communication write process
 *
...
/**
 * \brief   Callback function for i2c slave 0 communication read process
 *
 * Callback function for i2c communication read process
 * \retval  INFRA_EVT_RTN_NONE  to keep event alive
 * \retval  INFRA_EVT_RTN_CLEAR to clear event
 */
uint8_t evt_i2ccomm_0_rx_cb(void);  // i2c rx event handler

/**
 * \brief   Callback function for i2c slave 0 communication error process
 *
 * Callback function for i2c communication error process
 * \retval  INFRA_EVT_RTN_NONE  to keep event alive
 * \retval  INFRA_EVT_RTN_CLEAR to clear event
 */
uint8_t evt_i2ccomm_0_err_cb(void);  // i2c error event handler

/**
 * \brief   Callback function for i2c slave 1 communication write process
 *
 * Callback function for i2c communication write process
 * \retval  INFRA_EVT_RTN_NONE  to keep event alive
 * \retval  INFRA_EVT_RTN_CLEAR to clear event
 */
uint8_t evt_i2ccomm_1_tx_cb(void);    // i2c tx event handler


/**
 * \brief   Callback function for i2c slave 1 communication read process
 *
 * Callback function for i2c communication read process
 * \retval  INFRA_EVT_RTN_NONE  to keep event alive
 * \retval  INFRA_EVT_RTN_CLEAR to clear event
 */
uint8_t evt_i2ccomm_1_rx_cb(void);  // i2c rx event handler

/**
 * \brief   Callback function for i2c slave 1 communication error process
 *
 * Callback function for i2c communication error process
 * \retval  INFRA_EVT_RTN_NONE  to keep event alive
 * \retval  INFRA_EVT_RTN_CLEAR to clear event
 */
uint8_t evt_i2ccomm_1_err_cb(void);  // i2c error event handler
