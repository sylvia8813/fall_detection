...
APPL_DEFINES += -DHELLO_WORLD_CMSIS_CV
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TFLM_cmsis_cv_S_only.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TFLM_cmsis_cv_S_only.ld
endif
##
