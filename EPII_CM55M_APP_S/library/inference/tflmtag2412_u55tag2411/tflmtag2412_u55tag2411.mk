#"tensorflow (2024-12-20)- 01e31b74938a743b4a0f8edba6a6231bd93e8103": 
#"https://github.com/tensorflow/tflite-micro/archive/01e31b74938a743b4a0f8edba6a6231bd93e8103.zip"

#u55 driver
#"core-driver": "https://git.mlplatform.org/ml/ethos-u/ethos-u-core-driver.git/snapshot/ethos-u-core-driver-24.11.tar.gz"

# directory declaration
LIB_INFERENCE_ENGINE_DIR = $(LIBRARIES_ROOT)/inference/tflmtag2412_u55tag2411
LIB_INFERENCE_ENGINE_DEFINES = -DTFLM2412_U55TAG2411
...
LIB_INFERENCE_ENGINE_INCDIR	= $(LIB_INFERENCE_ENGINE_DIR) $(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro \
				...
				$(LIB_INFERENCE_ENGINE_DIR)/tensorflow \
...
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/compiler/mlir/lite/core/api/error_reporter.cc \
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/compiler/mlir/lite/schema/schema_utils.cc \
...
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/decompress_common.cc \
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/decompress.cc \
...
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/cmsis_nn/unidirectional_sequence_lstm.cc \
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/cmsis_nn/transpose_conv.cc \
...
# genearte library
ifeq ($(LIB_CMSIS_NN_ENALBE), 1)
INFERENCE_ENGINE_LIB_NAME = libtflmtag2412_u55tag2411_cmsisnn_$(TOOLCHAIN).a
lib_sel += cmsis_nn
else
INFERENCE_ENGINE_LIB_NAME = libtflmtag2412_u55tag2411_$(TOOLCHAIN).a
endif
