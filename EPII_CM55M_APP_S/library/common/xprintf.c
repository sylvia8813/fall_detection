...
//YX hook a empty xprintf for future. Only use TFM printf
__WEAK void xprintf(const char *fmt, ... ) {(void)fmt; }
__WEAK void xprintf_setup(){}
__WEAK void xprintf_desetup(){}
